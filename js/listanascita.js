var listaSpreadsheet =
  "https://docs.google.com/spreadsheets/d/e/2PACX-1vSludS87dakYeC1DvnthCZX1C38t24aqgm1NRE2Sye0b0QXp_hFK4rFhiJrlRrj1rtKgVAU6yZhujEL/pub?output=csv";
...
function showInfo(results) {
  ...
  for (var i = 0, len = data.length; i < len; i++) {
    if (data[i]["mostra"] == "TRUE") {
      ...
      foto_prod = "/foto-lista-nascita/" + prodotto["foto"] + ".jpg";
